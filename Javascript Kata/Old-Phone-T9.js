...
// the method to type words was called "multi-tap" and involved pressing a
// button repeatedly to cycle through the possible values.
//
// For example, to type a letter "R" you would press the 7 key three times
// (as the screen display for the current character cycles
//   through P->Q->R->S->7). A character is "locked in" once the user
//   presses a different key or pauses for a short period of time
//   (thus, no extra button presses are required beyond what is needed for
//     each letter individually). The zero key handles spaces, with one press
...
// would have to actually do 47 button presses. No wonder they abbreviated.
//
...
//
// Hint: While it wouldn't take too long to hard code the amount of
// keypresses for all 26 letters by hand, try to avoid doing so!
// (Imagine you work at a phone manufacturer who might be testing
//   out different keyboard layouts, and you want to be able to test new
//   ones rapidly.)
